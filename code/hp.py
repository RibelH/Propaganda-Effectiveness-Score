...
parser.add_argument("--evaluated_model", type=str, default='gpt-3.5-turbo-instruct-base')
parser.add_argument("--checkpoint", type=str, default='20240727-194322.pt')
parser.add_argument("--propgenset", type=str, default='./data/protechn_corpus_eval/propgen_{0}')
